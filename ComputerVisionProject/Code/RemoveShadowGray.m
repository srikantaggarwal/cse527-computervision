function outputImageText = RemoveShadowGray(InputImage, MaskImage)
%InputImage = rgb2gray(im2double(imread('inputImages/p4_1.jpg')));
%MaskImage = imread('gtMask/p4_1.png');

%outputImage = inputImage;
%outputImageText = inputImage;
...
for comp=1:1
    ...
    % maskImage = imread('gtMask/DSC_0559.png');
    BW = im2bw(MaskImage);
    dim = size(BW);
